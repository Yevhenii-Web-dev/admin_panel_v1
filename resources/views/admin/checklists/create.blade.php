        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="fade-in">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">{{ __('New Checklist in')}} {{ $checklistGroup->name  }}</h1>

                        <form action="{{ route('admin.checklist_groups.checklists.store', $checklistGroup) }}" method="POST" class="gy-2 gx-3 align-items-center" >
                            @csrf
