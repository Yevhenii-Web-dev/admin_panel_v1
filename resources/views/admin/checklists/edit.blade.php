            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="fade-in">
                        ...
                        <form action="{{ route('admin.checklist_groups.checklists.update', [$checklistGroup->id, $checklist->id] ) }}" method="POST" class="gy-2 gx-3 align-items-center" >
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input value="{{ $checklist->name }}" type="text" class="form-control" name="name" id="formGroupExampleInput">
                                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="delete-form" action="{{ route('admin.checklist_groups.checklists.destroy', [$checklistGroup->id, $checklist->id]) }}"  method="POST">
                        @csrf
                        @method('DELETE')
